...
class MasterCommittee extends Controller
{
    public function getLevel(Request $request)
    {
        ...
        try {
            ...
            return ResponseFormatter::success($data, 'Master Committee Level');
        } catch (\Throwable  $e) {
            Log::debug('getLevel');
            Log::debug($e);
    ...
    public function getLevelDetails($id)
    {
        try {
            ...
            $res = MLevelCommittee::baseQuery()
                ->where('id', '=', $id)
                ->get();
                return ResponseFormatter::success($res, 'Master Committee Level Details');
        } catch (\Throwable  $e) {
    ...
    public function addLevel(Request $request)
    {
        ...
        try {
            ...
            if ($master) {
                return ResponseFormatter::success($data, 'Master Committee Level created');
            } else {
    ...
    public function updateLevel(Request $request)
    {
        ...
        try {
            ...
            if ($affected) {
                return ResponseFormatter::success($data, 'Master Committe Level updated');                
            } else {
    ...
    public function getRole(Request $request)
    {
        ...
        try {
            ...
            return ResponseFormatter::success($data, 'Master Committee Role');
        } catch (\Throwable  $e) {
            Log::debug('getLevel');
            Log::debug($e);
    ...
    public function getRoleDetails($id)
    {
        try {
            ...
            $res = MRoleCommittee::baseQuery()
                ->where('id', '=', $id)
                ->get();
                return ResponseFormatter::success($res, 'Master Committee Role Detail');
        } catch (\Throwable  $e) {
    ...
    public function addRole(Request $request)
    {
        ...
        try {
            ...
            if ($master) {
                return ResponseFormatter::success($data, 'Master Committee Role created');
            } else {
                return ResponseFormatter::error([], 'Create Failed', 422);
            }
        } catch (\Throwable  $e) {
    ...
    public function updateRole(Request $request)
    {
        ...
        try {
            ...
            if ($affected) {
                return ResponseFormatter::success($data, 'Master Committee Role updated');                
            } else {
                return ResponseFormatter::error([], 'Updated Failed', 422);
            }
        } catch (\Throwable  $e) {
