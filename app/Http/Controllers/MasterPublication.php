...
class MasterPublication extends Controller
{
    public function getLevel(Request $request)
    {
        ...
        try {
            ...
            return ResponseFormatter::success($data, 'Master Publication Level');
        } catch (\Throwable  $e) {
            Log::debug('getLevel');
            Log::debug($e);
    ...
    public function addLevel(Request $request)
    {
        ...
        try {
            ...
            if ($master) {
                return ResponseFormatter::success($data, 'Master Publication Level created');
            } else {
    ...
    public function updateLevel(Request $request)
    {
        ...
        try {
            ...
            if ($affected) {
                return ResponseFormatter::success($data, 'Master Publication Level updated');                
            } else {
        ...
        try {
            ...
            if ($affected) {
                return ResponseFormatter::success([
                    'id'=>$id
                ], 'Master Publication Level deleted'); 
            } else {
    ...
    public function getRole(Request $request)
    {
        ...
        try {
            ...
            return ResponseFormatter::success($data, 'Master Publication Role');
        } catch (\Throwable  $e) {
            Log::debug('getLevel');
            Log::debug($e);
    ...
    public function getRoleDetails($id)
    {
        try {
            ...
            $res = MRolePublication::baseQuery()
                ->where('id', '=', $id)
                ->get();
            return ResponseFormatter::success($res, 'Master Publication Role Detail');
        } catch (\Throwable  $e) {
    ...
    public function updateRole(Request $request)
    {
        ...
        try {
            ...
            if ($affected) {
                return ResponseFormatter::success($data, 'Master Publication Role updated');                
            } else {
                return ResponseFormatter::error([], 'Updated Failed', 422);
            }
        } catch (\Throwable  $e) {
    ...
    public function deleteRole($id)
    {
        try {
            ...
            if ($affected) {
                return ResponseFormatter::success([
                    'id'=>$id
                ], 'Master Publication Role deleted');  
            } else {
                return ResponseFormatter::error([], 'Delete Failed', 422);
            }
        } catch (\Throwable  $e) {
