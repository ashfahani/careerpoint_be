...
class IntMemberOrganization extends Model
{
    protected $table = 't_int_organization_member';
    protected $perPage = 10;
	public $timestamps = true;

    protected $fillable = [
		'id_internal_organization', 'id_user', 'initial_period', 'final_period', 'id_level', 'id_role', 'score', 'role_description', 'approve', 'na', 'created_at', 'created_by', 'updated_at', 'updated_by'
    ];

    public static function baseQuery()
	{
		return DB::table('t_int_organization_member AS cp')
