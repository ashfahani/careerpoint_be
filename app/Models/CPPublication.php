...
class CPPublication extends Model
{
    protected $table = 't_cp_publication';
    protected $perPage = 10;
	public $timestamps = true;

    protected $fillable = [
		'id_activity_type', 'id_activity_category', 'id_user', 'activity_name', 'initial_period', 'final_period', 'period', 'organizer_name', 'organizer_location', 'id_level', 'id_role', 'score', 'approve', 'na', 'file', 'file_type', 'reject_text', 'id_internal_publication', 'send_email', 'created_at', 'created_by', 'updated_at', 'updated_by'
    ];

    public static function baseQuery()
	{
		return DB::table('t_cp_publication AS cp')
