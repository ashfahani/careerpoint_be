...
class IntMemberInternship extends Model
{
    protected $table = 't_int_internship_member';
    protected $perPage = 10;
	public $timestamps = true;

    protected $fillable = [
		'id_internal_internship', 'id_user', 'initial_period', 'final_period', 'id_level', 'id_role', 'score', 'role_description', 'approve', 'na', 'created_at', 'created_by', 'updated_at', 'updated_by'
    ];

    public static function baseQuery()
	{
		return DB::table('t_int_internship_member AS cp')
