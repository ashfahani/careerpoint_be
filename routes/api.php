...
Route::group(['middleware' => 'auth:sanctum', 'prefix' => 'master'], function () {
    ...
    Route::get('user/get-user/{id}', [UserController::class, 'getUsers']);   
    ...
    // Master Committee
    Route::get('committee/get-level', [MasterCommittee::class, 'getLevel']);
    Route::get('committee/get-level/{id}', [MasterCommittee::class, 'getLevel']);   
    ...
    Route::post('committee/update-level/{id}', [MasterCommittee::class, 'updateLevel']); 
    Route::post('committee/delete-level/{id}', [MasterCommittee::class, 'deleteLevel']);
    Route::get('committee/get-role', [MasterCommittee::class, 'getRole']);
    Route::get('committee/get-role/{id}', [MasterCommittee::class, 'getRole']);   
    ...
    Route::post('committee/update-role/{id}', [MasterCommittee::class, 'updateRole']); 
    Route::post('committee/delete-role/{id}', [MasterCommittee::class, 'deleteRole']);

    // Master Competition
    Route::get('competition/get-level', [MasterCompetition::class, 'getLevel']);
    Route::get('competition/get-level/{id}', [MasterCompetition::class, 'getLevel']);   
    ...
    Route::post('competition/update-level/{id}', [MasterCompetition::class, 'updateLevel']); 
    Route::post('competition/delete-level/{id}', [MasterCompetition::class, 'deleteLevel']);
    Route::get('competition/get-role', [MasterCompetition::class, 'getRole']);
    Route::get('competition/get-role/{id}', [MasterCompetition::class, 'getRole']);   
    ...
    Route::post('competition/update-role/{id}', [MasterCompetition::class, 'updateRole']); 
    Route::post('competition/delete-role/{id}', [MasterCompetition::class, 'deleteRole']);

    // Master Internship
    Route::get('internship/get-level', [MasterInternship::class, 'getLevel']);
    Route::get('internship/get-level/{id}', [MasterInternship::class, 'getLevel']);   
    ...
    Route::post('internship/update-level/{id}', [MasterInternship::class, 'updateLevel']); 
    Route::post('internship/delete-level/{id}', [MasterInternship::class, 'deleteLevel']);
    Route::get('internship/get-role', [MasterInternship::class, 'getRole']);
    Route::get('internship/get-role/{id}', [MasterInternship::class, 'getRole']);   
    ...
    Route::post('internship/update-role/{id}', [MasterInternship::class, 'updateRole']); 
    Route::post('internship/delete-role/{id}', [MasterInternship::class, 'deleteRole']);

    // Master Organization
    Route::get('organization/get-level', [MasterOrganization::class, 'getLevel']);
    Route::get('organization/get-level/{id}', [MasterOrganization::class, 'getLevel']);   
    ...
    Route::post('organization/update-level/{id}', [MasterOrganization::class, 'updateLevel']); 
    Route::post('organization/delete-level/{id}', [MasterOrganization::class, 'deleteLevel']);
    Route::get('organization/get-role', [MasterOrganization::class, 'getRole']);
    Route::get('organization/get-role/{id}', [MasterOrganization::class, 'getRole']);   
    ...
    Route::post('organization/update-role/{id}', [MasterOrganization::class, 'updateRole']); 
    Route::post('organization/delete-role/{id}', [MasterOrganization::class, 'deleteRole']);

    // Master Publication
    Route::get('publication/get-level', [MasterPublication::class, 'getLevel']);
    Route::get('publication/get-level/{id}', [MasterPublication::class, 'getLevel']);   
    ...
    Route::post('publication/update-level/{id}', [MasterPublication::class, 'updateLevel']); 
    Route::post('publication/delete-level/{id}', [MasterPublication::class, 'deleteLevel']);
    Route::get('publication/get-role', [MasterPublication::class, 'getRole']);
    Route::get('publication/get-role/{id}', [MasterPublication::class, 'getRole']);   
    ...
    Route::post('publication/update-role/{id}', [MasterPublication::class, 'updateRole']); 
    Route::post('publication/delete-role/{id}', [MasterPublication::class, 'deleteRole']);

    // Master Seminar
    Route::get('seminar/get-level', [MasterSeminar::class, 'getLevel']);
    Route::get('seminar/get-level/{id}', [MasterSeminar::class, 'getLevel']);   
    ...
    Route::post('seminar/update-level/{id}', [MasterSeminar::class, 'updateLevel']); 
    Route::post('seminar/delete-level/{id}', [MasterSeminar::class, 'deleteLevel']);
    Route::get('seminar/get-role', [MasterSeminar::class, 'getRole']);
    Route::get('seminar/get-role/{id}', [MasterSeminar::class, 'getRole']);   
    ...
    Route::post('seminar/update-role/{id}', [MasterSeminar::class, 'updateRole']); 
