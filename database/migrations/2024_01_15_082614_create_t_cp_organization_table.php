...
return new class extends Migration
{
    ...
    {
        Schema::create('t_cp_organization', function (Blueprint $table) {
            $table->id();
            $table->integer('id_activity_type');
            $table->integer('id_activity_category');
            ...
            $table->integer('id_internal_organization')->nullable();
    ...
    {
        Schema::dropIfExists('t_cp_organization');
    }
};
