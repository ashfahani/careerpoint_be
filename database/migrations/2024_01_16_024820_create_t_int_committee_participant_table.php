...
return new class extends Migration
{
    ...
    {
        Schema::create('t_int_committee_participant', function (Blueprint $table) {
            $table->id();
            $table->unsignedInteger('id_internal_committee');
    ...
    {
        Schema::dropIfExists('t_int_committee_participant');
    }
};
