...
return new class extends Migration
{
    ...
    {
        Schema::create('t_int_publication_member', function (Blueprint $table) {
            $table->id();
            $table->unsignedInteger('id_internal_publication');
    ...
    {
        Schema::dropIfExists('t_int_publication_member');
    }
};
